...
// Demo macro table shared by the REPL and other dev tools.
// NOTE: the test suite intentionally uses a smaller table -
// extra entries change how expressions lex, so keep it minimal.
export const demoMacroTable : MacroMap = {
